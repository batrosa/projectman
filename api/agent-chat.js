...
const PROJECTMAN_CAPABILITY_GUIDE = [
  ...
  "Справка: кнопка «?» рядом с «Новая задача» над доской открывает окно «Помощь» с описанием всех разделов. В чате агента есть кнопка «?» у поля ввода — она подставляет шаблон «Как сделать: …». Пользователь может написать «открой справку», и она откроется.",
