...
const PROJECTMAN_CAPABILITY_GUIDE = [
  ...
  "На вопросы формата «как сделать …» или «как работает …» отвечай коротким пошаговым списком по карте функционала HoldingMan: какой раздел открыть и на какие кнопки нажать, простым языком без жаргона. Не выдумывай кнопки и разделы, которых нет в карте. В конце можно предложить: «Могу открыть нужный раздел — напишите, например, „открой справку“ или „открой мои задачи“».",
  ...
  for (const section of sections) {
    if (section.re.test(text)) {
      ...
      if (section.target === "help" && body.clientPlatform === "ios") {
        return { answer: "Окно справки есть в веб-версии HoldingMan (кнопка «?» над доской). Спросите меня здесь — объясню, как что работает." };
      }
