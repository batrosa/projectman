...
export function buildProjectSferaLink({ taskId, projectId, organizationId } = {}) {
...
function projectManReplyMarkup({ taskId, projectId, organizationId, linkToProjectSfera } = {}) {
  ...
  return {
    inline_keyboard: [[{
      ...
      url: buildProjectSferaLink({ taskId, projectId, organizationId }),
    }]],
  };
}
