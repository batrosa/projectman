...
export function buildProjectManLink({ taskId, projectId, organizationId, taskCollection } = {}) {
...
function projectManReplyMarkup({ taskId, projectId, organizationId, taskCollection, linkToProjectMan } = {}) {
  ...
  return {
    inline_keyboard: [[{
      ...
      url: buildProjectManLink({ taskId, projectId, organizationId, taskCollection }),
    }]],
  };
}
