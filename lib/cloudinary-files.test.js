...
describe("Cloudinary file validation", () => {
  ...
  it("parses only legacy public URLs from our Cloudinary cloud", () => {
    process.env.CLOUDINARY_CLOUD_NAME = "demo";
    expect(legacyCloudinaryRef({ url: "https://res.cloudinary.com/demo/raw/upload/v123/docs/report.pdf" }))
      .toEqual({ publicId: "docs/report.pdf", resourceType: "raw", deliveryType: "upload" });
    expect(legacyCloudinaryRef({ url: "https://res.cloudinary.com/demo/image/upload/v123/photos/a.jpg" }))
      .toEqual({ publicId: "photos/a", resourceType: "image", deliveryType: "upload" });
    expect(legacyCloudinaryRef({ url: "https://res.cloudinary.com/other/raw/upload/v1/x.pdf" })).toBeNull();
    expect(legacyCloudinaryRef({ url: "https://evil.example/x.pdf" })).toBeNull();
  });
});
